...
const Menubar = React.forwardRef((_a, ref) => {
    ...
    return (_jsx(MenubarContext.Provider, { value: { openMenu, setOpenMenu }, children: _jsx(View, Object.assign({ ref: ref, className: cn("flex h-10 items-center space-x-1 rounded-md border border-border bg-background p-1", className) }, props)) }));
});
...
const MenubarMenu = ({ children }) => {
    ...
    const open = (context === null || context === void 0 ? void 0 : context.openMenu) === id;
    const onOpenChange = (isOpen) => {
        var _a, _b;
        if (isOpen) {
            (_a = context === null || context === void 0 ? void 0 : context.setOpenMenu) === null || _a === void 0 ? void 0 : _a.call(context, id);
        }
        else {
            (_b = context === null || context === void 0 ? void 0 : context.setOpenMenu) === null || _b === void 0 ? void 0 : _b.call(context, undefined);
        }
    };
    return (_jsx(MenubarMenuContext.Provider, { value: { id, open, onOpenChange, triggerId }, children: children }));
};
const MenubarTrigger = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    const context = React.useContext(MenubarMenuContext);
    return (_jsx(View, Object.assign({ ref: ref, id: context === null || context === void 0 ? void 0 : context.triggerId, "data-slot": "menubar-trigger", className: cn("flex cursor-default select-none items-center rounded-sm px-3 py-2 text-sm font-medium outline-none focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground", className), onClick: () => context === null || context === void 0 ? void 0 : context.onOpenChange(!context.open) }, props)));
});
...
const MenubarContent = React.forwardRef((_a, ref) => {
    ...
    return (_jsxs(Portal, { children: [_jsx(View, { className: "fixed inset-0 z-50 bg-transparent", onClick: () => context.onOpenChange(false) }), _jsx(View, Object.assign({ ref: ref, id: contentId.current, "data-slot": "menubar-content", "data-state": "open", "data-side": side, className: cn(baseClassName, className), style: contentStyle, onClick: (e) => e.stopPropagation() }, props, { children: _jsx(ScrollView, { scrollY: true, className: "max-h-[50vh] overflow-x-hidden overflow-y-auto", children: children }) }))] }));
});
MenubarContent.displayName = "MenubarContent";
const MenubarItem = React.forwardRef((_a, ref) => {
    var { className, inset, variant = "default", disabled, closeOnSelect = true, children, onClick } = _a, props = __rest(_a, ["className", "inset", "variant", "disabled", "closeOnSelect", "children", "onClick"]);
    const context = React.useContext(MenubarMenuContext);
    return (_jsx(View, Object.assign({ ref: ref, "data-slot": "menubar-item", "data-inset": inset ? "" : undefined, "data-variant": variant, "data-disabled": disabled ? "" : undefined, className: cn("relative flex cursor-default select-none items-center gap-1.5 rounded-md px-2 py-1 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50", "data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive data-[variant=destructive]:focus:bg-opacity-10 data-[variant=destructive]:focus:text-destructive", inset && "pl-7", disabled && "pointer-events-none opacity-50", className), onClick: (e) => {
            if (disabled)
                return;
...
const MenubarRadioGroup = React.forwardRef((_a, ref) => {
    ...
    return (_jsx(MenubarRadioGroupContext.Provider, { value: { value, onValueChange: handleValueChange }, children: _jsx(View, Object.assign({ ref: ref }, props)) }));
});
...
const MenubarRadioItem = React.forwardRef((_a, ref) => {
    ...
    return (_jsxs(View, Object.assign({ ref: ref, "data-slot": "menubar-radio-item", "data-inset": inset ? "" : undefined, "data-disabled": disabled ? "" : undefined, "data-state": checked ? "checked" : "unchecked", className: cn("relative flex cursor-default select-none items-center gap-1.5 rounded-md py-1 pr-8 pl-2 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50", inset && "pl-7", disabled && "pointer-events-none opacity-50", className), onClick: (e) => {
            var _a;
            if (disabled)
                return;
...
const MenubarLabel = React.forwardRef((_a, ref) => {
    ...
    return (_jsx(View, Object.assign({ ref: ref, "data-slot": "menubar-label", "data-inset": inset ? "" : undefined, className: cn("px-2 py-1 text-xs font-medium text-muted-foreground", inset && "pl-7", className) }, props)));
});
MenubarLabel.displayName = "MenubarLabel";
const MenubarSeparator = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx(View, Object.assign({ ref: ref, "data-slot": "menubar-separator", className: cn("-mx-1 my-1 h-px bg-border", className) }, props)));
});
MenubarSeparator.displayName = "MenubarSeparator";
const MenubarShortcut = (_a) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx(View, Object.assign({ "data-slot": "menubar-shortcut", className: cn("ml-auto text-xs tracking-widest text-muted-foreground", className) }, props)));
};
MenubarShortcut.displayName = "MenubarShortcut";
const MenubarGroup = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx(View, Object.assign({ ref: ref, "data-slot": "menubar-group", className: className }, props)));
});
MenubarGroup.displayName = "MenubarGroup";
const MenubarSubContext = React.createContext(null);
const MenubarSub = ({ open: openProp, defaultOpen, onOpenChange, children }) => {
    ...
    return (_jsx(MenubarSubContext.Provider, { value: { open, onOpenChange: handleOpenChange, triggerId: baseIdRef.current }, children: children }));
};
const MenubarSubTrigger = React.forwardRef((_a, ref) => {
    ...
    return (_jsxs(View, Object.assign({}, props, { ref: ref, id: subContext === null || subContext === void 0 ? void 0 : subContext.triggerId, "data-slot": "menubar-sub-trigger", "data-inset": inset ? "" : undefined, "data-disabled": disabled ? "" : undefined, "data-state": (subContext === null || subContext === void 0 ? void 0 : subContext.open) ? "open" : "closed", className: cn("relative flex cursor-default select-none items-center gap-1.5 rounded-md px-2 py-1 text-sm outline-none transition-colors focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground", inset && "pl-7", disabled && "pointer-events-none opacity-50", className), onClick: (e) => {
            var _a;
            e.stopPropagation();
            if (disabled)
                return;
...
const MenubarSubContent = React.forwardRef((_a, ref) => {
    ...
    return (_jsx(Portal, { children: _jsx(View, Object.assign({}, props, { ref: ref, id: contentId.current, "data-slot": "menubar-sub-content", "data-state": "open", "data-side": side, className: cn(baseClassName, className), style: contentStyle, onClick: (e) => e.stopPropagation(), children: _jsx(ScrollView, { scrollY: true, className: "max-h-[50vh] overflow-x-hidden overflow-y-auto", children: children }) })) }));
});
MenubarSubContent.displayName = "MenubarSubContent";
export { Menubar, MenubarMenu, MenubarTrigger, MenubarContent, MenubarItem, MenubarSeparator, MenubarLabel, MenubarCheckboxItem, MenubarRadioGroup, MenubarRadioItem, MenubarPortal, MenubarSubContent, MenubarSubTrigger, MenubarGroup, MenubarSub, MenubarShortcut, };
//# sourceMappingURL=menubar%202.js.map