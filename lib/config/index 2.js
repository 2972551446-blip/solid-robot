...
const generateTTProjectConfig = (outputRoot) => {
    const config = {
        miniprogramRoot: './',
    ...
    fs.writeFileSync(path.resolve(outputDir, 'project.config.json'), JSON.stringify(config, null, 2));
};
...
export default defineConfig(async (merge, _env) => {
    ...
    const outputRoot = ((_a = process.env.OUTPUT_ROOT) === null || _a === void 0 ? void 0 : _a.trim()) || defaultOutputRoot;
    ...
    const buildMiniCIPluginConfig = () => {
        ...
        return [['@tarojs/plugin-mini-ci', miniCIConfig]];
    };
    const baseConfig = Object.assign(Object.assign({ projectName: 'coze-mini-program', date: '2026-1-13', alias: {
            ...
            375: 2,
            828: 1.81 / 2,
        }, sourceRoot: 'src', outputRoot, plugins: ['@tarojs/plugin-generator', ...buildMiniCIPluginConfig()], defineConstants: {
    ...
    })), { jsMinimizer: 'esbuild', framework: 'react', compiler: {
            type: 'vite',
            vitePlugins: [
                {
                    ...
                    config(config) {
                        ...
                        if (typeof ((_a = config.css) === null || _a === void 0 ? void 0 : _a.postcss) === 'object') {
                            (_c = (_b = config.css) === null || _b === void 0 ? void 0 : _b.postcss.plugins) === null || _c === void 0 ? void 0 : _c.unshift(tailwindcss());
                        }
                    },
                },
                {
